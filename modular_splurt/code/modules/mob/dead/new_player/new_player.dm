/mob/dead/new_player/proc/new_player_panel()
	if(client?.prefs.toggles & TG_PLAYER_PANEL)
		return
	var/output = "<center><p>Добро пожаловать, <b>[client ? client.prefs.real_name : "Unknown User"]</b>!</p>"
	...
	if(SSticker.current_state <= GAME_STATE_PREGAME)
		...
		output += "<p><a href='byond://?src=[REF(src)];manifest=1'>Манифест экипажа</a></p>"
	...
	var/datum/browser/popup = new(src, "playersetup", "<div align='center'>Настройки для нового игрока</div>", 250, 265)
