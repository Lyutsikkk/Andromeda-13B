#define LOADOUT_SUBCATEGORIES_DON01 "Первый уровень"
#define LOADOUT_SUBCATEGORIES_DON02 "Второй уровень"
#define LOADOUT_SUBCATEGORIES_DON03 "Третий уровень"
#define LOADOUT_SUBCATEGORIES_DON04 "Разработка" // Раздел для разработчиков, мапперов и спрайтеров, вносящих вклад в проект
